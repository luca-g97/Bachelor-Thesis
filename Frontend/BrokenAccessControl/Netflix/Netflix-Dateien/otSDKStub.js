var OneTrustStub = function (t) {
    ...
    (l = m = m || {})[l.Days = 1] = "Days", l[l.Weeks = 7] = "Weeks", l[l.Months = 30] = "Months", l[l.Years = 365] = "Years", (l = e = e || {}).Name = "OTGPPConsent", l[l.ChunkSize = 4e3] = "ChunkSize", l.ChunkCountParam = "GPPCookiesCount", (l = {
        ...
        8: "CPRA",
        CCPA: 8
    })[8] = "CCPA", l[l.CDPA = 9] = "CDPA", l[l.USNATIONAL = 7] = "USNATIONAL", l[l.COLORADO = 10] = "COLORADO";
    var r, e, a = "geo", o = "otpreview", s = (e.Name, "PRODUCTION"),
    ...
    var c = new function () {
        ...
        e && e.CookieV2BulkDomainManagement && i !== n && t.ScriptType === s && ((e = window.sessionStorage) && e.getItem("bulkDomainMgmtEnabled") ? this.handleBulkDomainMgmt({isValid: "true" === window.sessionStorage.getItem("bulkDomainMgmtEnabled")}, t) : (n = {
        ...
        var t = "data-dLayer-ignore", e = u.stubScriptElement.hasAttribute(t), t = u.stubScriptElement.getAttribute(t);
        this.otDataLayer = {
            ignore: e && "true" === t || e && "" === t,
            name: u.stubScriptElement.getAttribute("data-dLayer-name") || "dataLayer"
        }
    }, d.prototype.setGeoLocation = function (t, e) {
        u.userLocation = {country: t, state: e = void 0 === e ? "" : e}
        ...
        for (var s = a.state.toLowerCase(), r = a.country.toLowerCase(), p = 0; p < t.RuleSet.length; p++) if (!0 === t.RuleSet[p].Global) n = t.RuleSet[p]; else {
        ...
        var t = u.stubScriptElement.getAttribute("src"), e = -1 < t.indexOf("/consent");
    ...
    function d() {
        ...
        this.iabType = null, this.iabTypeAdded = !0, this.crossOrigin = null, this.isAmp = !1, this.domainId = "", this.isReset = !1, this.isPreview = !1, this.geoFromUrl = "", this.nonce = "", this.setAttributePolyfillIsActive = !1, this.storageBaseURL = "", this.charset = null, this.addBannerSDKScript = function (t) {
            ...
            p.__cmpCall && "IAB" === l.iabType ? (n = p.__cmpCall.callId, a = p.__cmpCall.command, t = p.__cmpCall.parameter, l.executeCmpApi(a, t, function (t, e) {
                t = {__cmpReturn: {returnValue: t, success: e, callId: n, command: a}};
                ...
                t = {__tcfapiReturn: {returnValue: t, success: e, callId: o, command: s}};
            ...
            if ("function" == typeof a && i) if (u.isStubReady && u.IABCookieValue) switch (i) {
                case"ping":
            ...
            var a = window, o = "IAB" === l.iabType ? "__cmp" : "__tcfapi";
