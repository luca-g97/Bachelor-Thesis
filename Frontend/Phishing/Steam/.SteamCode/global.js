	...
	$J.get( 'https://steamcommunity.com/sharedfiles/ajaxeditcontentdescriptors/', { publishedfileid: publishedfileid } )
		.done( function( json ) {
			if ( json.success == 1 )
			{
				...
				var dialog = ShowConfirmDialog( 'Inhaltsbeschreibungen aktualisieren', content );
				...
				dialog.done( function() {
					...
					).done( function( json )
					{
						...
						{
							ShowAlertDialog( 'Inhaltsbeschreibungen aktualisieren', 'Bei der Aktualisierung der Inhaltsbeschreibungen für diesen Inhalt ist ein Problem aufgetreten: ' + json.success );
						}
					} );
				} );
			}
